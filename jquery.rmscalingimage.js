...
(function($){
	...
	$.fn.rmScalingImage = function(config){
		...
		var defaults = $.fn.rmScalingImage.defaults = {
		...
		var setStyle = $.rmScalingImage.setStyle = function(config){
		...
		var setImageSize = $.rmScalingImage.setImageSize = function(){
		...
		if(img.get(0).width === 0){
			img.load(function(){
				natural = $.rmScalingImage.getNaturalSize(this);
				wrap.trigger('onSetNaturalSize');
			});
		} else{
			natural = $.rmScalingImage.getNaturalSize(img.get(0));
			wrap.trigger('onSetNaturalSize');
		}
	...
	$.rmScalingImage.getNaturalSize = function(image){
